...
|:--------------:|:-------:|:--------:|:--------:|:-------:|:-------:|:----------------------:|:-------:|:-----:|:-----:|:--------:|:--------:|:------:|:-------:|:-------:|
| Basic Usage    | ?1.2.2+ | ?2.01.0+ | ?0.2.23+ | ?0.5.3+ | 1.29.3+ | ?shvrA93uplusm-v1.0.1+ | ?6.7.5+ | ?R30+ | ?6.5+ | ?0.25.0+ | ?0.12.6+ | ?2.10+ | ?0.3.0+ | ?4.0.9+ |
| Builtin Search | ?1.2.2+ | ?2.01.0+ | ?0.2.23+ | ?0.5.3+ | 1.29.3+ | ?shvrA93uplusm-v1.0.1+ | ?6.7.5+ | ?R30+ | ?6.5+ | ?0.25.0+ | 0.14.5+  | ?2.10+ | ?0.3.0+ | 4.2.7+  |
