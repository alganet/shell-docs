...
|:--------------:|:--------:|:----------:|:--------:|:----------:|:--------:|:---------------------------:|:-------:|:------:|:-------:|:--------:|:--------:|:--------:|:--------:|:-------:|
| Basic Usage    | >=1.27.2 | >=2.05b.13 | >=0.2.23 | >=0.5.5.1  | >=1.29.3 | >=2007-01-11                | >=6.7.5 | >=R45  | >=6.5   | >=0.25.0 | >=0.12.6 | >=2.45   | >=0.4.5  | -       |
| Builtin Search | >=1.27.2 | >=2.05b.13 | >=0.2.23 | >=0.5.5.1  | >=1.29.3 | >=2007-01-11                | >=6.7.5 | >=R45  | >=6.5   | >=0.25.0 | >=0.14.3 | -        | -        | >=4.2.7 |
