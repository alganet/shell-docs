...
- **exec** [_command_ [_argument_...]]

---

[POSIX Specification](https://pubs.opengroup.org/onlinepubs/9799919799/utilities/V3_chap02.html#exec)

Basic Usage
-----------

`exec` replaces the current shell with _command_, so nothing after it ever runs.
