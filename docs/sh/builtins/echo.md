...
| Option: -n    | -        | >=2.05b.13 | >=0.2.23 | >=0.5.5.1  | -        | >=2007-01-11                | >=6.7.5 | >=R45  | >=6.5   | >=0.25.0 | >=0.12.6 | -        | >=0.4.5  | >=4.2.7 |
| Option: -e    | -        | >=2.05b.13 | >=0.2.23 | -          | -        | >=2007-01-11                | >=6.7.5 | >=R45  | >=6.5   | >=0.25.0 | -        | -        | >=0.4.5  | >=4.2.7 |
| Option: -E    | -        | >=2.05b.13 | >=0.2.23 | -          | -        | -                           | >=6.7.5 | >=R45  | >=6.5   | -        | -        | -        | >=0.4.5  | >=4.2.7 |
