...
| Option: -n    | -         | >=2.01.0   | >=0.2.23 | >=0.5.3    | -         | >=2007-01-11                | >=6.7.5 | >=R30  | >=6.5   | >=0.25.0 | >=0.12.6 | >=2.10   | >=0.3.0  | >=4.0.9 |
| Option: -e    | -         | >=2.01.0   | >=0.2.23 | -          | -         | >=2007-01-11                | >=6.7.5 | >=R30  | >=6.5   | >=0.25.0 | -        | >=2.10   | >=0.3.0  | >=4.0.9 |
| Option: -E    | -         | >=2.01.0   | >=0.2.23 | -          | -         | -                           | >=6.7.5 | >=R30  | >=6.5   | -        | -        | >=2.10   | >=0.3.0  | >=4.0.9 |
